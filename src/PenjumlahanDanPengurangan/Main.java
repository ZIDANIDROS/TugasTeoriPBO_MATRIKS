package PenjumlahanDanPengurangan;

import PenjumlahanDanPengurangan.Matriks.Pecahan;
import PenjumlahanDanPengurangan.Matriks.Matrik;
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("PenjumlahanDanPengurangan.Pecahan 1: " + pecahan1);
        System.out.println("PenjumlahanDanPengurangan.Pecahan 2: " + pecahan2);
        ...
        // Mengisi matriks1 dan matriks2 dengan PenjumlahanDanPengurangan.Pecahan
        Matrik matriks1 = new Matrik(2, 2);
        Matrik matriks2 = new Matrik(2, 2);

        PenjumlahanDanPengurangan.Matriks.Pecahan[][] data = {
                {p1, p2},
                {p3, p4}
        };
        ...
        System.out.println("PenjumlahanDanPengurangan.Matriks 1:");
        System.out.println(matriks1.toString());

        System.out.println("PenjumlahanDanPengurangan.Matriks 2:");
        System.out.println(matriks2.toString());

        System.out.println("Hasil Penjumlahan PenjumlahanDanPengurangan.Matriks:");
        System.out.println(hasilTambah1.toString());

        System.out.println("Hasil Pengurangan PenjumlahanDanPengurangan.Matriks:");
        System.out.println(hasilKurang1.toString());

        System.out.println("Transpose PenjumlahanDanPengurangan.Matriks 1:");
